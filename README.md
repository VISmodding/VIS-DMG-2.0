...
**IMPORTANT FIX for mainboard v2.0 (this fix, to lower the noise, will be added in coming soon new 2 layers version)** Solder a 220 pF capacitor in parallel to R70 as shown in the following image (in the same place hence you will have a resistor with a capacitor soldered on it). This capacitor improves the loop stability of the boost U3 and practically you will have extremely low noise. In addition, add 220uF cap as shown in the image. I ensure you that you never heard a so low noise Gameboy.
